    ...
    <div className="pt-2 lg:grid lg:grid-cols-[1fr_280px] lg:items-start lg:gap-6">
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between lg:hidden">
          ...
          <button
            ...
            className="flex items-center gap-1 font-mono text-[11px] text-muted-foreground transition-colors hover:text-signal"
          >
            <Swords size={12} />
            STATUS
          </button>
      ...
      <LogSetSheet
        ...
        onSave={(reps, sets, rpe) => {
          ...
          quest.awardSessionXp(action === "progress");
